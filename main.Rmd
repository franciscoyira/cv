...
- Highly skilled in R (tidyverse, rmarkdown and other packages), data visualisation, presentations (public speaking) and collaboration.

- Experienced in Python, statistical analysis, machine learning, causal inference and experimental design (A/B Testing).
...
Francisco Yirá {#title}
--------------------------------------------------------------------------------

### Data Scientist and Economist

Data Scientist, Bachelor of Economics, and advanced R programmer. I have experience using machine learning to solve business problems in retail and marketing/CRM, answering business questions through statistical modeling and causal inference, and automating processes and reports.
