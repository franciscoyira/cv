...
- <i class="fa fa-globe"></i> [My data science blog](https://franciscoyira.com)
...
Libertad y Desarrollo (Think Tank)
...
::: concise
- Coauthored published research on shale gas' economic impact. 
- Updated the institute's public data bank.
- Assisted in research about energy, environment and labour market issues.
:::
...
### [DevOps on AWS](https://www.coursera.org/account/accomplishments/specialization/HCPFFS3XPN6T)
...
- 4-course specialisation introducing the AWS ecosystem and walking through hands-on exercises about DevOps concepts and tasks.

### [Causal Inference with R (blog posts series)](https://www.franciscoyira.com/categories/causal-inference/)
...
### [Analysing my music collection with Python and R](https://franciscoyira.com/post/music-analysis-python-pandas-matplotlib-r/)
...
### [alicer: An internal R package to accelerate Walmart Chile analytics](https://onedrive.live.com/?authkey=%21AAyPFA9VDF00udA&cid=59E4C7D110DACCCC&id=59E4C7D110DACCCC%21509515&parId=59E4C7D110DACCCC%21509517&o=OneUp) *(Spanish)*
